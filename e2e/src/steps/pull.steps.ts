...
When('I pull chapter {int} of {string}', async function (this: E2EWorld, chapterNumber: number, mangaTitle: string) {
  ...
  await detailPage.pullChapter(chapterNumber);
});

Then('chapter {int} is pulled', async function (this: E2EWorld, chapterNumber: number) {
