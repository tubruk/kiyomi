...
func NewRequest(ctx context.Context, urlStr, providerID, explicitReferer string) (*http.Request, error) {
	return (*RequestBuilder)(nil).BuildRequest(ctx, urlStr, providerID, explicitReferer)
}
...
func (b *RequestBuilder) BuildRequest(ctx context.Context, urlStr string, providerID string, explicitReferer string) (*http.Request, error) {
	...
	isMangaFox := baseProviderID == "mangafox" || strings.Contains(urlStr, "fanfox.net") || strings.Contains(urlStr, "mfcdn.net") || strings.Contains(urlStr, "mangafox.me") || strings.Contains(urlStr, "zjcdn")
	isMangaDex := baseProviderID == "mangadex" || strings.Contains(urlStr, "mangadex.org") || strings.Contains(urlStr, "mangadex.network")
	...
	if len(cookies) > 0 {
		...
		if b != nil && b.httpClient != nil {
			...
			if req.URL != nil && b.httpClient.Jar != nil {
